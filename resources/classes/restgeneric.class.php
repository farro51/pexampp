...
class RestGeneric extends Entity {
    ...
    public function getResourceList(){
        ...
        if (isset($this->_properties->Resources) && is_array($this->_properties->Resources)){
            foreach($this->_properties->Resources as $resource){
                $r = new SpecificationEntity();
                $r->TargetNamespace = new SpecificationNamespace('restresource', Restos::URIRest('restresource'));
                $r->seeAlso = Restos::URIRest($resource);
                $r->about = $resource;
                $list[] = $r;
            }
        }
     ...
     * @return object
     */
    public function getDriverData ($resource_name) {
        $driver = $this->getProperty('ResourcesConfiguration->' . $resource_name . '->Driver');
        ...
        $connector = $this->getProperty('ResourcesConfiguration->' . $resource_name . '->DriverConnector');
